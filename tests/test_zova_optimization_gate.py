...
def state(route: str, workload: str) -> dict:
    ...
    return {
        ...
        "statement_metrics": {
            "canonical_files": {"rows": 2, "bind_i64_calls": 4, "bind_text_calls": 2,
                "bind_double_calls": 0, "step_calls": 2, "reset_calls": 2,
                "clear_bindings_calls": 2},
            "canonical_nodes": {"rows": 2, "bind_i64_calls": 12, "bind_text_calls": 10,
                "bind_double_calls": 0, "step_calls": 2, "reset_calls": 2,
                "clear_bindings_calls": 2},
            "canonical_edges": {"rows": 1, "bind_i64_calls": 3, "bind_text_calls": 5,
                "bind_double_calls": 0, "step_calls": 1, "reset_calls": 1,
                "clear_bindings_calls": 1},
            "canonical_hashes": {"rows": 2, "bind_i64_calls": 6, "bind_text_calls": 2,
                "bind_double_calls": 0, "step_calls": 2, "reset_calls": 2,
                "clear_bindings_calls": 2},
            "canonical_token_metadata": {"rows": 2, "bind_i64_calls": 2,
                "bind_text_calls": 4, "bind_double_calls": 2, "step_calls": 2,
                "reset_calls": 2, "clear_bindings_calls": 2},
            "full_fts_bulk_statements": 0,
            "full_fts_trigger_rows_avoided": 0,
            "full_node_guard_validation_statements": 0,
            "full_edge_guard_validation_statements": 0,
        },
        "snapshot": {
